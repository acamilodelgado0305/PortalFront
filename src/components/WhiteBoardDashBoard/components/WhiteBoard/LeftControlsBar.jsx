...
const TrashBinClearerButton = ({ context, style }) => (
  <Button onClick={() => context.clearWhiteBoard(emitToSocket)} style={style}>
    {/* trashBlack */}
    <img
      src={trashBlack}
      alt="uploadBlack Icon"
...
const CurrentDrawToolPickerButtons = ({ context, style }) => {
  ...
  const tools = [
    ...
    },
    {
      ...
      icon: (
        <img
          src={segmentIconBlack}
          alt="segmentIconBlack Icon"
          style={{ width: "30px", height: "30px" }}
        />
      ),
    },
