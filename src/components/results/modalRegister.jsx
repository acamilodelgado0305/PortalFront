...
function ModalRegister({ selectedTeacher, closeRegisterModal }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="max-h-full w-11/12 md:w-3/12 rounded-lg bg-white p-6 shadow-lg font-normal">
        <div className=" w-full grid justify-items-center grid-cols-1 border-b">
          ...
          <p>Learn with teacher {selectedTeacher.firstName}</p>
        </div>
      <form
     onSubmit={(e) => onchangeData(e)}
       className="p-5 text-sm md:text-lg">
        ...
        <div className="mt-4  p-2 border rounded text-sm">
            ...
            <div 
            className="grid justify-items-center grid-cols-1  gap-7 md:gap-3  p-2 mt-4" action="">
